   ...
   String EName;
    ...
    private void populateTable() {
        ...
        try (Connection conn = DBConnection.getConnection()) {
            String sql = "SELECT EMPID, EmployeeName, Title FROM employees";
            try (PreparedStatement pstmt = conn.prepareStatement(sql);
                ...
                while (rs.next()) {
                    ...
                    // Add data to JTable model
                    model.addRow(new Object[]{empID, empName, title});
                }
            }
...
model = (DefaultTableModel) jTable.getModel();
    if (jTable.getSelectedRowCount() == 1) {
        ...
        ObjController.updateEmployee(EID, EName, Etitle);
        ...
        model.setValueAt(Etitle, jTable.getSelectedRow(), 2);
             ...
             JOptionPane.showMessageDialog(rootPane, "Updated", "Success", JOptionPane.INFORMATION_MESSAGE);
    }//GEN-LAST:event_UpdateActionPerformed
else {
            if (jTable.getSelectedRowCount() == 0) {
            JOptionPane.showMessageDialog(rootPane, "Table Is Empty", "Info", 0);
            } else {
                JOptionPane.showMessageDialog(rootPane, "Please Select At Least One Row", "Info", 0);
            }
        }
    }      
...
if (jTable.getSelectedRowCount() == 1) {
        String EMPID = model.getValueAt(jTable.getSelectedRow(), 0).toString();
        ObjController.deleteEmployee(EMPID);
        
        model.removeRow(jTable.getSelectedRow());
        EmployeeList.remove(index);
        JOptionPane.showMessageDialog(rootPane, "Deleted Employee", "Success", JOptionPane.INFORMATION_MESSAGE);
        index--;
    ...
    private void AddActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_AddActionPerformed
        ...
        index++;
        ObjEmployee = ObjController.addEmployee(EID, EName, Etitle);
        ...
        model.addRow(new Object[]{
            ...
            JOptionPane.showMessageDialog(rootPane, "Added Employee " + index, "Success", JOptionPane.INFORMATION_MESSAGE);
