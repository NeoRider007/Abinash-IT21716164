...
public class SalesManagementSystemUI extends javax.swing.JFrame {

    DefaultTableModel model;
    Ship ObjShip;
    ShipController ObjController;
    ArrayList<Ship> ShipList;
    int index;

    public SalesManagementSystemUI() {
        initComponents();

        ObjController = new ShipController();
    ...
    private void initComponents() {
        ...
        txtSHID = new javax.swing.JTextField();
        ...
        txtSHID.setFont(new java.awt.Font("Dialog", 1, 18)); // NOI18N
        txtSHID.setBorder(javax.swing.BorderFactory.createTitledBorder(""));
        txtSHID.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                txtSHIDActionPerformed(evt);
            }
        });
        ...
        jLabel9.setText("Inventory type");
        ...
        jPanel3Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel3Layout.createSequentialGroup()
                ...
                .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(txtSHID, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.DEFAULT_SIZE, 258, Short.MAX_VALUE)
        ...
        jPanel3Layout.setVerticalGroup(
            ...
            .addGroup(jPanel3Layout.createSequentialGroup()
                ...
                .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    ...
                    .addComponent(txtSHID, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addGap(116, 116, 116)
                .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
        ...
        jLabel7.setText("Inventory Managment");
    ...
    private void bSearchActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bSearchActionPerformed
        try {
            ...
            for (Ship S : ShipList) {
                if (S.getSHID().contains(searchWatch)) {
    ...
    private void bUpdateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bUpdateActionPerformed
        ...
        if (jTable1.getSelectedRowCount() == 1) {
            ...
            model.setValueAt(SHID, jTable1.getSelectedRow(), 3);
    ...
    private void bAddActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bAddActionPerformed
        try {
            ...
            index++;
            ObjShip = ObjController.addShip(SHID, CName, CID ,CMail );
    ...
    private void jTable1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTable1MouseClicked
        ...
        String tblSHID = model.getValueAt(jTable1.getSelectedRow(), 3).toString();


        txtCName.setText(tblCName);
        txtCID.setText(tblCID);
        txtCMail.setText(tblCMail);
        txtSHID.setText(tblSHID);
    ...
    private void txtSHIDActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_txtSHIDActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_txtSHIDActionPerformed
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            ...
            public void run() {
                new SalesManagementSystemUI().setVisible(true);
            }
        });
    }
    ...
    private javax.swing.JTextField txtSHID;
